"""
Django settings for DIRT Stacks project.
...
DJANGO_VITE_ASSETS_PATH = BASE_DIR / 'dirt_fe_vue' / 'dist'
...
WSGI_APPLICATION = "dirt_demo_vue.wsgi.application"
ROOT_URLCONF = "dirt_demo_vue.urls"
